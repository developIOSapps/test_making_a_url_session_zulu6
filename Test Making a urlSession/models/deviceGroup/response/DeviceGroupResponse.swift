...
struct DeviceGroupResponse: OurCodable {
    ...
    static func loadTheData() -> DeviceGroupResponse {
        ...
        guard let json = try? JSONDecoder().decode(DeviceGroupResponse.self, from: jsonData) else {
            fatalError("decoding")
        }
